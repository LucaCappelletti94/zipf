...
latex_documents = [
    (master_doc, 'zipf.tex', 'zipf Documentation',
     'Luca Cappelletti', 'manual'),
]
...
man_pages = [
    (master_doc, 'zipf', 'zipf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zipf', 'zipf Documentation',
     author, 'zipf', 'One line description of project.',
     'Miscellaneous'),
]
